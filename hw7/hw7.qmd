...
This database project is designed to manage and represent the collective skills, roles, and certifications of employees within a company. It aims to facilitate the identification of specific skills and roles within the organization, helping in resource allocation and talent management.
...
* first_name and last_name: The first and last names of the employee.
* email: The email address of the employee.
* linkedin_url: A URL linking to the employee's LinkedIn profile.
* headshot_url: A URL to a headshot image of the employee.
* discord_handle: The employee's Discord username or handle.
* brief_bio: A short biography or description of the employee.
...
* description: A brief description of the skill or certification, explaining its nature and scope.
* tag: A category tag that groups the skill into a broader classification.
* url: A URL pointing to resources or additional information about the skill.
* time_commitment: An estimated time commitment required to acquire or master the skill.
...
* id: A unique identifier for each role within the company.
* name: The name of the role, such as Developer, Designer, Team Lead, etc.
* sort_priority: An integer representing the hierarchical or sorting priority of the role, which can be used to organize roles in a specific order.
...
#| eval: true
sql = """
SELECT p.first_name, p.last_name, p.emailFROM people p
